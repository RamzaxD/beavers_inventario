...
public class UsuariosControlador {
    ...
    @PostMapping()
    public ResponseEntity<?> guardarUsuario(@RequestBody UsuariosDTO usuarioDTO) {
        try {
            UsuariosModelo usuarioGuardado = this.usersServicio.guardarUsuarioDesdeDTO(usuarioDTO);
